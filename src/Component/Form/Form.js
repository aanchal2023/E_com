...
function Form() {
  return (
    <>
      <div className="container mt-5 text-center mt-5 mb-4">
        <div className="row mt-5 mb-4 border border-dark rounded">
              ...
              <div className="form-data">
                ...
                <div>
                  <form>
                    ...
                    <div className="row">
                      <div className="col">
                        <button type="submit" className="btn " style={{ backgroundColor: "  #07492bf5" }}>
                          Login
                        </button>
                      </div>
                      <div className="col">
          ...
          <div className="col loginclass img-fluid img-thumbnail" style={{ backgroundColor: " #f5bd6968" ,boxSizing:"border-box", padding:"50px 10px 20px 10px"}}>
            <img src={require("../Img/logIn Image.png")} className="" />
          </div>
        </div>
      </div>
    </>
